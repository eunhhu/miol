...
- `orv verify-build <dir>` — build manifest/plan target 존재, source bundle hash, server artifact, static page zero-runtime shape, client page/JS/WASM bootstrap, optional dev HMR session 검증
