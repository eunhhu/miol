...
- `orv dev <file-or-orv.toml> --out <dir> [--hmr] [--watch] [--watch-loop]` — build + verify-build + run-build reference dev bootstrap, optional HMR/watch session manifest, opt-in poll loop event manifest
