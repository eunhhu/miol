...
- Deploy artifacts: `deploy/manifest.json`, `deploy/container.json`, `deploy/compose.yaml`, `deploy/env.example`, `deploy/db-adapters.json`, `deploy/commerce-adapters.json`, `deploy/README.md`
