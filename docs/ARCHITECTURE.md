...
| `orv-compiler` | HIR origin map, build manifest/bundle plan, native server plan/source contract 생성. 코드 생성/최적화 단계는 로드맵 | orv-diagnostics, orv-hir, serde |
