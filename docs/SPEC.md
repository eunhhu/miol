...
| `orv verify-build <dir>` | build manifest/plan target, server runtime/launch artifact, static page zero-runtime shape, client WASM magic/version 검증 |
