...
| `orv reveal <dir> <origin-id>` | build artifact origin id를 source span, ProjectGraph node, route descriptor, native server target/build-run command/runtime image plan 또는 client manifest/bundle target으로 역추적 |
