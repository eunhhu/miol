...
| `orv verify-build <dir>` | build manifest/plan target, source bundle hash, deploy route inventory, server runtime/launch artifact, static page zero-runtime shape, client page/JS/WASM metadata와 `orv_start` bootstrap, optional dev HMR/watch session 검증 |
