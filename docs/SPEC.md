...
| `orv db plan/apply/migrate/rollback/backup/restore` | schema diff dry-run, snapshot apply/history, 선택적 JSON data snapshot migrate/rollback, local backup/restore |
