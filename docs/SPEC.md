...
| `orv verify-build <dir>` | build manifest/plan target, source bundle hash, server runtime/launch artifact, static page zero-runtime shape, client page/JS/WASM bootstrap 검증 |
