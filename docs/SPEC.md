...
| `orv db plan/verify/apply/migrate/rollback/backup/restore` | schema diff dry-run/verify, snapshot apply/history, 선택적 JSON data snapshot migrate/rollback, local backup/restore |
