...
| `orv lock [dir-or-orv.toml] [--check]` | `orv.toml` project/dependency metadata와 local/file/HTTP registry `index.json` 기반 prerelease/build-aware exact/wildcard/caret/tilde/comparator range 결과에서 deterministic `orv.lock` 생성 또는 최신성 검증 |
