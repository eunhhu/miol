...
| `orv db plan/verify/apply/migrate/rollback/backup/restore/recover/squash` | schema diff dry-run/verify, snapshot apply/history/squash, 선택적 JSON data snapshot migrate/rollback, local backup/restore, WAL record recovery |
