...
- `orv db restore --archive archive.json --data data.json --at 2026-05-02T12:00:00Z` — 현재 구현: hash-verified archive manifest WAL을 지정 시점까지 재생해 snapshot 복원
