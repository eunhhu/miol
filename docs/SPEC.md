...
| `orv workspace build [root] --out <dir> [--prod]` | workspace member별 build/verify 실행 후 `members/<member>` artifacts, `workspace-graph.json`, `workspace-build.json` 출력 |
