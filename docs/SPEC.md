...
| `orv init <dir> --name <name> [--template basic\|shop]` | 최소 프로젝트 또는 쇼핑몰 `GET /` HTML 홈 및 회원/결제/배송 route scaffold와 검증/Compose 배포 README 생성 |
