...
| `orv init <dir> --name <name> [--template basic\|shop]` | 최소 프로젝트 또는 쇼핑몰 `GET /` HTML form 홈, 회원/결제/배송 route scaffold, local `@payment`/`@shipping` reference adapter 사용, `data/shop.wal.jsonl` WAL 지속성, 검증/Compose 배포 README 생성 |
