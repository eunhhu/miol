...
| `orv editor snapshot/reveal/runtime/export` | first-party editor bootstrap JSON + build-origin navigation payload + runtime inspection pane JSON + static editor shell artifact 출력 |
