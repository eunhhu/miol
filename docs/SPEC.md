...
| `orv deploy-env-check <dir>` | production `deploy/commerce-adapters.json`의 provider credential env contract를 읽어 required provider env 누락을 배포 전 실패로 보고하고 optional webhook secret 누락은 허용 |
