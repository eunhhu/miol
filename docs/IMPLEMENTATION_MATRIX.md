...
| `orv init <dir> --template shop` | implemented | experimental | M2 | `orv-cli` | `fixtures/e2e/shopping_mall.orv` | `orv init` | Catalog/cart/member/checkout/admin scaffold with editable `@design` color/spacing/typography tokens on the home shell |
